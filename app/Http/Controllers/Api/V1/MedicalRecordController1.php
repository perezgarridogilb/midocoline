...
class MedicalRecordController1 extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $userId = $user->id; // Obtener el ID del usuario
            ...
            // Verificar si el usuario ya tiene dos registros clínicos
    if (MedicalRecord::where('user_id', $userId)->count() >= 8) {
        return response()->json([
            'Status' => 'Error',
            'Message' => 'El usuario ya tiene dos expedientes clínicos registrados. No se permite crear más.',
